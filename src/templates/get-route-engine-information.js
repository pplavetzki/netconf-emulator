...
// Generated from mock_responses/get-route-engine-information.xml
const PAYLOAD = String.raw`<route-engine-information xmlns="http://xml.juniper.net/junos/15.1R5/junos-chassis">
  <route-engine>
    <slot>0</slot>
    ...
    <memory-dram-size>1024 MB</memory-dram-size>
