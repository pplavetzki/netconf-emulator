...
// Generated from mock_responses/get-fpc-information.xml
const PAYLOAD = String.raw`<fpc-information xmlns="http://xml.juniper.net/junos/19.4R0/junos-chassis" junos:style="brief">
  <fpc>
    <slot>0</slot>
    <state>Online</state>
    <temperature junos:celsius="0">N/A</temperature>
    <cpu-total>12</cpu-total>
...
export function getFpcInformation(device) {
